...
# Plot with OpenStreetMap basemap NO2
ggplot() +
  annotation_map_tile(type = "osm", zoom = 10) +  # OpenStreetMap tiles
...
# Plot with OpenStreetMap basemap, focusing on King County, WA 

ggplot() + annotation_map_tile(type = "osm", zoom = 11) + # Adjust zoom level for King County 
  geom_sf(data = newgrid_king_county, aes(fill = predicted_pm25), color = NA, alpha = 0.8) + scale_fill_viridis_c(option = "plasma", name = "PM2.5 (µg/m³)") + labs( title = "Predicted PM2.5 Concentrations in Snohomish, King, and Pierce Counties, WA",
...
# Plot with the corrected color scheme and appropriate transpare