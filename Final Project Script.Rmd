...
This is super basic at the moment - could use some more work.
...
full_data_w_preds_perc <- full_data_w_preds %>% 
    mutate(
           ...
           p_Hispanic = (Hawaiian_PacificIslander / Total_Pop)*100,
...
# Summary of associations between PM2.5 and demographics
