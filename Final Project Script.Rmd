...
grid_covar_clean <- grid_covariates %>%
  ...
  # select(c(location_id, native_id, tract_key, m_to_l_airp, m_to_a1,
  #          m_to_bus, m_to_coast,m_to_comm, elev_1k_above, elev_5k_above,
  #          elev_1k_at_elev, elev_5k_at_elev, elev_1k_below, elev_5k_below,
  #          elev_elevation, elev_1k_stdev, elev_5k_stdev, imp_a00050,
  #          imp_a00100, imp_a00150, imp_a00300, imp_a00400, imp_a00500,
  #          imp_a00750, imp_a01000, imp_a03000, rlu_decid_forest_p00500,
  #          rlu_decid_forest_p00750, rlu_decid_forest_p01000,
  #          rlu_dev_hi_p00300, rlu_dev_hi_p00400, rlu_dev_hi_p00500,
  #          rlu_dev_hi_p00750, rlu_dev_hi_p01000, rlu_dev_hi_p03000,
  #          rlu_dev_hi_p05000, rlu_dev_lo_p00050, ))

### commented above - some of the variables included in the mobile monitoring predictions, not all of them MISSING: no2_behr
